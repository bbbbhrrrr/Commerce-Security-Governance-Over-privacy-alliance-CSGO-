# ray start --head --node-ip-address="192.168.114.139" --port="20001" --include-dashboard=False --disable-usage-stats         
...
sf.init(address='192.168.114.139:20001', log_to_driver=True, cluster_config=cluster_config)
