...
总恶意行为次数=$$\sum f_i(x_i,y_i,z_i)$$

基础公式：ln(x + e^y + e\*e^z)

仅退款不退货次数、金额、比例：ln(x + e^y + e\*e^z)
租用不还次数、金额、比例：ln(50\*x + e\*e^y + e\*e^z)
收货后仅支付订金次数、金额、比例：ln(x + e\*e^y + e\*e^z)
付款不发货次数、金额、比例：ln(x + e^y + 50\*e^z)
